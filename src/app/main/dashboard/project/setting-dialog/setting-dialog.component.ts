...
export class SettingDialogComponent implements OnInit {
  ...
  topics: any[] = [
  {
    ...
    groupValue: [
      ...
      {id: 3, value: "drivemotor_imu", stationname: "/SMARTPANGO/PU2001/DRIVE_MOTOR/IMU"},
      {id: 4, value: "drivemotor_temp", stationname: "/SMARTPANGO/PU2001/DRIVE_MOTOR/TEMPERATURE"}
    ]
  }, {
    name: 'Custom',
    groupValue: [
      {id: 1, value: "custom", stationname: "User's Customization"}
    ]
  }
  ];
